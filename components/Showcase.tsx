...
const projects: Project[] = [
  ...
  {
    id: 14,
    title: 'Guess A Word Showcase',
    category: 'Multiplayer',
    desc: 'Full game overview showcasing the lobby, round flow, and end-screen.',
    tags: ['Multiplayer', 'UI', 'Round System'],
    size: 'small',
    gradient: 'from-violet-900/30 to-dark-700',
    video: '/videos/Guess A Word Showcase.mp4',
  },
  {
    id: 15,
    title: 'Guess A Word Practice',
    category: 'Gameplay',
    desc: 'Solo practice mode letting players train before jumping into live rounds.',
    tags: ['Gameplay', 'Solo Mode', 'UI'],
    size: 'small',
    gradient: 'from-cyan-900/30 to-dark-700',
    video: '/videos/Guess A Word Practice Showcase.mp4',
  },
  {
    id: 16,
    title: 'Physic Drag System',
    category: 'Gameplay',
    desc: 'Physics-based drag system letting players grab and move objects with realistic weight and momentum.',
    tags: ['Physics', 'Gameplay', 'Interaction'],
    size: 'large',
    gradient: 'from-orange-900/30 to-dark-700',
    video: '/videos/Physic Drag System.mp4',
  },
  {
    id: 17,
    title: 'Hunger System',
    category: 'Gameplay',
    desc: 'Survival hunger mechanic with stat decay, visual indicators, and food interaction.',
    tags: ['Survival', 'DataStore', 'UI'],
    size: 'small',
    gradient: 'from-green-900/30 to-dark-700',
    video: '/videos/Hunger System.mp4',
  },
  {
    id: 10,
    title: 'Steal A Card',
